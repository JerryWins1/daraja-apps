...
const APPS = {
 ...
 flipkit: {
  ...
  lines:[
   "This is FlipKit — the only app in this store that pays for itself the first time you use it.",
   "Here's the truth: your garage, your closets, your basement — they're hiding a few hundred dollars. Maybe more.",
   "The reason it never gets sold? Two chores: figuring out what it's worth, and writing the listing. FlipKit kills both.",
   "Add a thing — 'Weber grill, five years old, good condition.' Tap one button.",
   "FlipKit hands your own AI — ChatGPT, Claude, whichever you use — a pricing question. Attach a photo, paste the answer back.",
   "Now look: a smart asking price. A don't-go-below floor. And a listing — title and description — written to get messages.",
   "Tap copy, paste it on Facebook Marketplace. Done in ninety seconds.",
   "The big number at the top shows what ALL your stuff is worth. Watching it turn into the cash line? That's the fun part.",
   "There's even a selling-safely card — meet in public, cash only, trust your gut.",
   "Nine dollars, once. The first thing you flip pays for it. Everything after that is yours.",
   "Try it right now with the button below — go add the thing you almost sold last spring."],
  train:[
